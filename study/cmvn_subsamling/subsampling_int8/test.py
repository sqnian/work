...
def gen_data(batch, seq_len, idim, odim):
    ...
    inputs = torch.randn([batch, 64, 710, 80], 
...
def test():
    ...
    out_cu = conformer_infer_opt.test_func(i_int8,w_int8_arr,alpha_arr,bias1,
    ...
    # start_time = time.time()
    # for i in range(num_iter):
    #     cuda_conv = conformer_infer_opt.test_func(i_int8,i_int8.flatten(),w_int8_arr, w_int8_arr.flatten(),alpha_arr,bias1,
